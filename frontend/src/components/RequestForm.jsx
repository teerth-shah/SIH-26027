      ...
      >
        <div>
          ...
          <select
            ...
            className="w-full p-2 border rounded bg-slate-50 text-sm mb-3"
          >
        ...
        <button
          type="submit"
          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 rounded-lg flex items-center justify-center space-x-2 transition-colors mt-2"
        >
          <Send size={16} />
