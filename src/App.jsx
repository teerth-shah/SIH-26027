...
// --- NOTIFICATIONS ---
  ...
  const handleRequestSubmit = (data) => {
    ...
    // HACKATHON DEMO TRICK: simulate backend approval until real approval events exist
    setTimeout(() => {
      addNotification('Request approved', 'Your manual block request has been approved.', 'approved');
    }, 4000);
  };
